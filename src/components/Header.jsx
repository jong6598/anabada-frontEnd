...
const Header = () => {
  ...
  useEffect(()=>{
    if(pathnameRef.current === null){
      return pathnameRef.current = true;
    }
    if(pathname==="/login"){
      const loginPath = document.querySelector("header__user__login")
...
const MainNav = styled.div`
  ...
  .header__nav {
    ...
    .header__nav__home {
      ...
      border-bottom: ${(props) =>
        props.pathname === "/" ? "0.1rem solid #2756FF" : "inherit"};
    }
  }
`;
