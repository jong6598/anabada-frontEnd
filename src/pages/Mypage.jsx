...
const Mypage = () => {
    ...
    const updateImg = async () => {
        ...
        const result = window.confirm('변경된 프로필 사진을 등록하시겠습니까?');
            if (result) {
                const res = await myApi.uploadProfile(profileUrl)
                console.log("이미지 보내기 성공!")
                console.log(profileUrl, "보낸 형식 확인")
                } else {
    ...
    return (
        <>
            ...
            <SelectDiv>
                <h1>피드 리스트</h1>
                <BtnDiv>
                    <Btn onClick={() => navigate(`/myposts`)}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.66224 21.7501L6.90475 21.7502L22.4611 6.1938L18.2185 1.95117L2.66211 17.5075L2.66224 21.7501Z" fill="#1C1B1F" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.4453 5.66303C13.7381 5.37014 14.213 5.37014 14.5059 5.66303L18.7486 9.90568C19.0415 10.1986 19.0415 10.6734 18.7486 10.9663C18.4557 11.2592 17.9808 11.2592 17.6879 10.9663L13.4453 6.72369C13.1524 6.4308 13.1524 5.95592 13.4453 5.66303Z" fill="#1C1B1F" />
                        </svg>
                    ...
                    <Btn onClick={() => navigate(`/myposts`)}>
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8 4C4.96244 4 2.5 6.46245 2.5 9.5C2.5 15 9 20 12.5 21.1631C16 20 22.5 15 22.5 9.5C22.5 6.46245 20.0375 4 17 4C15.1398 4 13.4953 4.92345 12.5 6.3369C11.5047 4.92345 9.86015 4 8 4Z" fill="#FF2D55" />
                ...
                <AllBtn onClick={() => navigate('/myposts')} ><svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0.96967 0.46967C1.26256 0.176777 1.73744 0.176777 2.03033 0.46967L8.03033 6.46967C8.32322 6.76256 8.32322 7.23744 8.03033 7.53033L2.03033 13.5303C1.73744 13.8232 1.26256 13.8232 0.96967 13.5303C0.676777 13.2374 0.676777 12.7626 0.96967 12.4697L6.43934 7L0.96967 1.53033C0.676777 1.23744 0.676777 0.762563 0.96967 0.46967Z" fill="#1C1B1F" />
                </svg>
                </AllBtn>
            </SelectDiv>
            <SelectDiv>
                <h1>오픈 모임 리스트</h1>
                <BtnDiv>
                    <Btn onClick={() => navigate(`/mymeets`)}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.5 12C11.706 12 13.5 10.206 13.5 8C13.5 5.794 11.706 4 9.5 4C7.294 4 5.5 5.794 5.5 8C5.5 10.206 7.294 12 9.5 12ZM11 13H8C4.691 13 2 15.691 2 19V20H17V19C17 15.691 14.309 13 11 13Z" fill="black" />
                ...
                <AllBtn onClick={() => navigate('/mymeets')}><svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0.96967 0.46967C1.26256 0.176777 1.73744 0.176777 2.03033 0.46967L8.03033 6.46967C8.32322 6.76256 8.32322 7.23744 8.03033 7.53033L2.03033 13.5303C1.73744 13.8232 1.26256 13.8232 0.96967 13.5303C0.676777 13.2374 0.676777 12.7626 0.96967 12.4697L6.43934 7L0.96967 1.53033C0.676777 1.23744 0.676777 0.762563 0.96967 0.46967Z" fill="#1C1B1F" />
                </svg>
                </AllBtn>
            </SelectDiv>
